...
class ImageModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_nb):
        ...
        # Xu Dong: this is interesting. The output from the network got smoothed
        # (improved) a bit by blending with the gt. 
        # I guess this can help with the training stability.
